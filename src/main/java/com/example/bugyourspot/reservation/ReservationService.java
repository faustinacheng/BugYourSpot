...
public class ReservationService {
    ...
    public void createReservation(ReservationDTO reservationDTO) {
        ...
        // Check if all of the requested time slots are available
